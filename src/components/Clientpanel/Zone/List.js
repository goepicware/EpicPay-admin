...
class List extends Component {
  ...
  removeItem(deleteID) {
    var params = { zone_id: deleteID, company_id: this.state.companyID };
              ...
              <div className="container-xxl flex-grow-1 container-p-y">
                <div className="row mb-3">
                  <div className="col-lg-10 col-md-6">
                    <h4 className="fw-bold">Zone</h4>
                  </div>
                  <div className="col-lg-2 col-md-6 text-end">
                    <Link to={"/clientpanel/zone/add"}>
                      <button
                        type="button"
                ...
                <div className="row mb-4">
                  <div className="col-md-3">
                    <div className="form-floating form-floating-outline mb-4">
                      ...
                      />
                      <label htmlFor="outlet_pos_id">Zone Name</label>
                    </div>
                  </div>
                          ...
                          this.state.listdata.map((item, index) => {
                            return (
                              <tr key={index}>
                                ...
                                <td>{item.zone_delivery_charge}</td>
                                <td>{item.zone_min_amount}</td>
                                <td> {showStatus(item.zone_status)}</td>
                                <td>
                                  <div className="dropdown">
                                    ...
                                    <div className="dropdown-menu">
                                      <Link
                                        to={
                                          "/clientpanel/zone/edit/" +
                                          encodeValue(item.zone_id)
                                        }
