...
class OrderAdvancedDatetimeSlot extends Component {
    ...
    if (Object.keys(propsDtTm).length > 0) {
      ...
      if (getDateTimeFlg === "yes") {
        this.setState(
          { dateTimeErroTxt: "" },
          function () {
            this.getAvailableDates(sldAvilablityId, orderTatTm);
          }.bind(this)
        );
  ...
  getAvailableDates(sldAvilablityId, orderTatTm) {
    if (sldAvilablityId !== "") {
      axios
        .get(
          apiUrl +
            "clientpanel/timeslot/slotDetails?company_id=" +
        ...
        .then((res) => {
          ...
          if (res.data.status === "success") {
            ...
            dateTimeErroTxt =
              "Our apologies, the date/time slot selected is not available. <span>Please select another date/time.</span>";
          }
  ...
  setOrderDateFun() {
    ...
    if (Object.keys(resultSetdata).length > 0) {
      ...
      var orderDateTime = this.props.hdrState.orderDateTime;
  ...
  setOrderTimeSlotFun() {
    ...
    if (Object.keys(timeSlotListObj).length > 0 && selectedDate !== "") {
      ...
      if (
        ...
        var orderSlotVal = this.props.hdrState.orderSlotVal;
        if (orderSlotVal !== "") {
          ...
          if (crtutc === sltutc) {
            if (parseFloat(curDyHrMt) < parseFloat(strDyHrMt)) {
              ...
              ordSlotLbl = this.props.hdrState.orderSlotTxt;
              ordSlotStr = this.props.hdrState.orderSlotStrTime;
              ordSlotEnd = this.props.hdrState.orderSlotEndTime;
            }
          } else {
            startTime = setHours(
              setMinutes(new Date(), startMinitValNew),
  ...
  setOrderTimeFun() {
    ...
    if (Object.keys(resultSetdata).length > 0 && selectedDate !== "") {
      ...
      if (finaldays_data.length > 0) {
        ...
        var selectedTime = this.props.hdrState.deliveryTime;
            ...
            <div className="row">
              <div className="col-xl-3">
                <div className="syd_date">
                  {this.props.labelDateName !== "" &&
                    typeof this.props.labelDateName !== undefined &&
                    typeof this.props.labelDateName !== "undefined" && (
                      <h5>{this.props.labelDateName}</h5>
                    )}
              ...
              <div className="col-xl-3">
                {this.state.timeSlotType === "2" ? (
                  <div className="syd_time">
                    {this.props.labelTimeName !== "" &&
                      typeof this.props.labelTimeName !== undefined &&
                      typeof this.props.labelTimeName !== "undefined" && (
                        <h5>{this.props.labelTimeName}</h5>
                      )}
                    <div className="form-group222">
                      {this.state.showTimePk === "yes" ? (
                        ...
                        >
                          <select
                            ...
                            className="form-control time-slot-select"
                            onKeyDown={(e) => {
                              e.preventDefault();
                            }}
                          >
