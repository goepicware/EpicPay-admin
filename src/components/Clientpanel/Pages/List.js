                ...
                <div className="row mb-4">
                  <div className="col-md-3">
                    <div className="form-floating form-floating-outline mb-4">
                      ...
                      />
                      <label htmlFor="outlet_pos_id">Page Name</label>
                    </div>
                  </div>
                  <div className="col-md-3">
                        ...
                        {this.state.loading === true ? (
                          ...
                          this.state.listdata.map((item, index) => {
                            return (
                              <tr key={index}>
                                <td>
                                  <strong>{item.cmspage_title}</strong>
                                </td>
                                <td>{item.cmspage_slug}</td>
                                <td>{showStatus(item.cmspage_status)}</td>
                                <td>
